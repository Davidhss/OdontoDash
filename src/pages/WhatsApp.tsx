...
import { MessageCircle, Wifi, WifiOff, RefreshCw, LogOut, Search, Users, Bell, BellOff, Target } from 'lucide-react';
...
const WhatsApp: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Chat Area */}
      <div className="flex-1 flex rounded-2xl border border-border-card overflow-hidden bg-background-card shadow-xl shadow-black/5">
        {/* Chat List Panel */}
        <div className="w-[360px] border-r border-border-card flex flex-col bg-background-card">
          {/* Search */}
          <div className="p-3 border-b border-border-card">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2.5 bg-background-app border border-border-card rounded-xl text-sm text-text-primary placeholder:text-text-tertiary focus:outline-none focus:border-emerald-500/50 transition-colors"
              />
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col">
          {activeChat ? (
            <>
              {/* Chat Header */}
              <div className="px-5 py-3 border-b border-border-card flex items-center justify-between bg-background-card">
                <div className="flex items-center gap-3">
